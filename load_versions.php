<?php
  ...
  $modele_query = "SELECT * FROM model WHERE ModelID = '".$_POST['model_id']."'";
  ...
  $version_query = "SELECT * FROM versions WHERE vid BETWEEN '".$start_version."' AND '".$end_version."' ORDER BY vid DESC";
